...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    platformRadioButtons.forEach(button => {
     ...
     async function fetchLightsailRegions(){
        try {
            const response = await fetch(`${baseUrl}/lightsail-regions`);
    ...
    async function fetchBlueprints(region, platform){
        try{
            const response = await fetch(`${baseUrl}/lightsail-blueprints?region=${region}&platform=${platform}`);
            const data = await response.json();
    ...
    async function fetchInstancePlans(selectedPlatform, selectedRegion){
        try{
            const response = await fetch(`${baseUrl}/lightsail-instance-plans?platform=${selectedPlatform}&region=${selectedRegion}`);
            const data = await response.json();
            return data.bundles;
        } catch (error){
    ...
    form.addEventListener('submit', async function(event) {
        try {
            ...
            const response = await fetch(`${baseUrl}/deploy-lightsail`, {
                method: 'POST',
                headers: {
